...
void BaseApplication::createFrameListener(void)
{
	...
	Button_All[23] =mTrayMgr->createButton(OgreBites::TL_BOTTOMLEFT,"Back_main","Back",200);
	Button_All[24] =mTrayMgr->createButton(OgreBites::TL_BOTTOMLEFT,"Back_Choice","Back",200);
	Button_All[25] =mTrayMgr->createButton(OgreBites::TL_BOTTOMLEFT,"Back_TimeLimit","Back",200);
